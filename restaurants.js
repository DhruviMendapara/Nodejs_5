...
db.restaurant
  .find(
    { name: "/ces/$" },
    { restaurant_id: 1, name: 1, borough: 1, cuisin: 1 }
  )
  .pretty();
...
db.restaurant.find(
  { "grades.score": { $lt: 10 } },
  { restaurant_id: 1, name: 1, borough: 1, cuisin: 1, "grades.score": 1 }
);
...
db.restaurant
  .find({}, { cuisine: 1, borough: 1 })
  .sort({ cuisine: 1, borough: -1 });

db.restaurant.find({}, { cuisine: 1 }).sort({ cuisine: 1 });
db.restaurant.find({}, { borough: 1 }).sort({ borough: -1 });
